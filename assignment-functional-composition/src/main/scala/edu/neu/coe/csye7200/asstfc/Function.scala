...
object Function {
  ...
  def lift[T, R](f: T => R): Try[T] => Try[R] = {
    def g(t1y: Try[T]): Try[R] = Try(f(t1y.get))
    g
  }
  ...
  def lift2[T1, T2, R](f: (T1, T2) => R): (Try[T1], Try[T2]) => Try[R] = {
    def g(t1y: Try[T1], t2y: Try[T2]): Try[R] = Try(f(t1y.get, t2y.get))
    g
  }
  ...
  def lift3[T1, T2, T3, R](f: (T1, T2, T3) => R): (Try[T1], Try[T2], Try[T3]) => Try[R] = {
    def g(t1y: Try[T1], t2y: Try[T2], t3y: Try[T3]): Try[R] = Try(f(t1y.get, t2y.get, t3y.get))
    g
  }
  ...
  (Try[T1], Try[T2], Try[T3], Try[T4], Try[T5], Try[T6], Try[T7]) => Try[R] = {
    def g(t1y: Try[T1], t2y: Try[T2], t3y: Try[T3], t4y: Try[T4], t5y: Try[T5], t6y: Try[T6], t7y: Try[T7]): Try[R] =
  ...
  def invert2[T1, T2, R](f: T1 => T2 => R): T2 => T1 => R = (t2y: T2) => (t1y: T1) => f(t1y)(t2y)
  ...
  def invert3[T1, T2, T3, R](f: T1 => T2 => T3 => R): T3 => T2 => T1 => R =(t3y: T3)=>(t2y: T2)=>( t1y: T1) => f(t1y)(t2y)(t3y)
  ...
  def invert4[T1, T2, T3, T4, R](f: T1 => T2 => T3 => T4 => R): T4 => T3 => T2 => T1 => R = (t4y: T4)=>(t3y: T3)=>(t2y: T2)=>( t1y: T1) => f(t1y)(t2y)(t3y)(t4y)
  ...
  def uncurried2[T1, T2, T3, R](f: T1 => T2 => T3 => R): (T1, T2) => T3 => R = (t1y: T1, t2y: T2) => (t3y: T3) => f(t1y)(t2y)(t3y)
  ...
  def uncurried3[T1, T2, T3, T4, R](f: T1 => T2 => T3 => T4 => R): (T1, T2, T3) => T4 => R = (t1y: T1, t2y: T2, t3y: T3) => (t4y: T4) => f(t1y)(t2y)(t3y)(t4y)
  ...
  def uncurried7[T1, T2, T3, T4, T5, T6, T7, T8, R](f: T1 => T2 => T3 => T4 => T5 => T6 => T7 => T8 => R): (T1, T2, T3, T4, T5, T6, T7) => T8 => R =
    (t1y: T1, t2y: T2, t3y: T3, t4y: T4, t5y: T5, t6y: T6, t7y: T7) => (t8y: T8) => f(t1y)(t2y)(t3y)(t4y)(t5y)(t6y)(t7y)(t8y)
